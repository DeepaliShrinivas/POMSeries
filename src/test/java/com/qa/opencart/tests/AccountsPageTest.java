...
public class AccountsPageTest extends BaseTest{
	...
	public void accPageSectionsCountTest() {
		Assert.assertEquals(accPage.getAccountPageHeadersCount(), 
				Constants.ACC_PAGE_SECTIONS_COUNT,Error.ACC_PAGE_SECTIONS_ERROR);
	}
    ...
    public void selectProductTest() {
    	...
    	softAssert.assertEquals(productInfoPage.getProductImageCount(), Constants.PRODUCT_IMAGES_COUNT_MACBOOK);
